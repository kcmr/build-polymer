...
function htmlTransform(html, options) {
    ...
    for (const script of allScripts) {
        ...
        if (isInline) {
            ...
            const newJs = js_transform_1.jsTransform(dom5.getTextContent(script), Object.assign(Object.assign({}, options.js), { transformModulesToAmd: false }));
...
function transformEsModuleToAmd(script, jsOptions) {
    ...
    if (isExternal) {
        ...
        const newJs = js_transform_1.jsTransform(dom5.getTextContent(script), Object.assign(Object.assign({}, jsOptions), { transformModulesToAmd: true }));
        dom5.setTextContent(script, newJs);
    }
}
