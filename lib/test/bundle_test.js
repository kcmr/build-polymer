...
suite('BuildBundler', () => {
    ...
    let bundledStream;
    let files;
    const setupTest = (projectOptions, bundlerOptions, transform) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('entrypoint only', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            root: defaultRoot,
    ...
    test('two fragments', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            root: defaultRoot,
    ...
    test.skip('shell and entrypoint', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            entrypoint: 'entrypoint-a.html',
            shell: 'shell.html',
        });
    ...
    test('shell and fragments with shared dependency', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            root: defaultRoot,
            entrypoint: 'entrypoint-a.html',
            shell: 'shell.html',
    ...
    test.skip('entrypoint and fragments', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            entrypoint: 'entrypoint-a.html',
            fragments: [
                'shell.html',
    ...
    test('bundler loads changed files from stream', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
    ...
    test('bundler deals with win32 platform separators on win32', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('bundler deals with posix platform separators on win32', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('bundler does not output inlined html imports', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('bundler outputs html imports that are not inlined', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('bundler does not output inlined scripts or styles', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            root: path.resolve('test-fixtures/bundle-project'),
            entrypoint: 'index.html',
        });
    ...
    test('bundler does output scripts and styles not inlined', () => __awaiter(void 0, void 0, void 0, function* () {
        yield setupTest({
            root: path.resolve('test-fixtures/bundle-project'),
            entrypoint: 'index.html',
        }, {
    ...
    suite('options', () => {
        ...
        test('excludes: html file urls listed are not inlined', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('excludes: html files in folders listed are not inlined', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('excludes: nothing is excluded when no excludes are given', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('stripComments: false, does not strip html comments', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('stripComments: true, strips html comments', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('strategy: fn(), applies bundle strategy function', () => __awaiter(void 0, void 0, void 0, function* () {
            yield setupTest(projectOptions, {
        ...
        test('urlMapper: fn(), applies bundle url mapper function', () => __awaiter(void 0, void 0, void 0, function* () {
