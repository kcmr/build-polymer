...
suite('AsyncTransformStream', () => {
    test('transforms input', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('fails if the stream does not consume all input', () => __awaiter(void 0, void 0, void 0, function* () {
