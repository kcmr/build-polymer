...
suite('jsTransform', () => {
    ...
    suite('compilation', () => {
        ...
        test('compiles ES2017 to ES5', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    suite('parse errors', () => {
        ...
        test('do not throw when softSyntaxError is true', () => __awaiter(void 0, void 0, void 0, function* () {
            const output = yield util_1.interceptOutput(() => __awaiter(void 0, void 0, void 0, function* () {
