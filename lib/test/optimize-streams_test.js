...
suite('optimize-streams', () => {
    ...
    suite('JS compilation', () => {
        test('compiles to ES5 if compile=true', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('compiles ES2017 to ES2015', () => __awaiter(void 0, void 0, void 0, function* () {
            const sourceStream = createFakeFileStream([
                {
                    path: 'foo.js',
        ...
        test('does not compile webcomponents.js files (windows)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('does not compile webcomponents.js files (unix)', () => __awaiter(void 0, void 0, void 0, function* () {
            const es6Contents = `const apple = 'apple';`;
            const sourceStream = createFakeFileStream([
                {
    ...
    suite('rewrites bare module specifiers to paths', () => {
        test('in js files', () => __awaiter(void 0, void 0, void 0, function* () {
      ...
      `);
        ...
        test('in html inline scripts', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    suite('transforms ES modules to AMD', () => __awaiter(void 0, void 0, void 0, function* () {
        test('inline and external script tags', () => __awaiter(void 0, void 0, void 0, function* () {
            const files = [
                {
                    path: 'index.html',
                    contents: `
        ...
        test('auto-detects when to transform external js', () => __awaiter(void 0, void 0, void 0, function* () {
            const files = [
                {
    ...
    test('minify js', () => __awaiter(void 0, void 0, void 0, function* () {
        const sourceStream = createFakeFileStream([
            {
                path: 'foo.js',
                contents: 'var foo = 3',
    ...
    test('minify js (es6)', () => __awaiter(void 0, void 0, void 0, function* () {
        const sourceStream = createFakeFileStream([
            {
                path: 'foo.js',
    ...
    test('js exclude permutations', () => __awaiter(void 0, void 0, void 0, function* () {
        const files = [
            {
                path: 'minify.js',
    ...
    test('minify html', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('minify css', () => __awaiter(void 0, void 0, void 0, function* () {
        const sourceStream = createFakeFileStream([
            {
                path: 'foo.css',
    ...
    test('minify css (inlined)', () => __awaiter(void 0, void 0, void 0, function* () {
