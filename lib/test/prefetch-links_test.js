...
suite('prefetch-links', () => {
    suite('AddPrefetchLinks', () => {
        test('adds prefetch links for transitive deps of unbundled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('add prefetch links for transitive deps of bundled', () => __awaiter(void 0, void 0, void 0, function* () {
            const project = new polymer_project_1.PolymerProject({
                root: 'test-fixtures/bundle-project/',
                entrypoint: 'index.html',
        ...
        test('prefetch links do not include lazy dependencies', () => __awaiter(void 0, void 0, void 0, function* () {
            const project = new polymer_project_1.PolymerProject({
        ...
        test('prefetch links are relative when base tag present', () => __awaiter(void 0, void 0, void 0, function* () {
            const project = new polymer_project_1.PolymerProject({
